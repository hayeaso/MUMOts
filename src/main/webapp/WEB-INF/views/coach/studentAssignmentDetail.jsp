					...
					<div class="col-md-4">
						<div class="input-icon">
							<input type="text" class="form-control" id="dateTime"
								name="dateTime" value="${emailScheduler.sendEmailDateTime}"
								required />
						</div>
					</div>
				</div>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Test is generated and data will be send to the student as
					scheduled!</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"
					OnClick="closeModalCoachAssignment()">Close</button>
			</div>
		</div>
	</div>
</div>
...
<script
	src="<c:url value="/metronic/assets/coach/scripts/assignment.js" />"
...
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-waitingfor/1.2.4/bootstrap-waitingfor.js"></script>
