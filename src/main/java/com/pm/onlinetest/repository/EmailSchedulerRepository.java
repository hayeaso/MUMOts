...
public interface EmailSchedulerRepository extends CrudRepository<EmailScheduler, Integer>{
	...
	*/
	@Query("SELECT e FROM EmailScheduler e, Assignment a WHERE e.sendEmailDateTime <= :dateTime and e.isSend = true and a.started=false and a.finished=false and e.assignmentId=a.id")
